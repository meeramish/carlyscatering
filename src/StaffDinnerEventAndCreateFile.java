...
public class StaffDinnerEventAndCreateFile {
    public static void main(String[] args) {
        try {
            ...
            DinnerEvent[] dinnerEventList = new DinnerEvent[3];
            for (int cnt = 0; cnt < 3; cnt++) {
                dinnerEventList[cnt] = createDinnerEvent(cnt);
                ...
                int guests=0;
                int price=0;
                s= dinnerEventList[cnt].getEventNumber() + delimiter+ dinnerEventList[cnt].getGuests() +delimiter+ 
                        dinnerEventList[cnt].getEventType() + delimiter + dinnerEventList[cnt].getPriceForEvent()
    ...
    static DinnerEvent createDinnerEvent(int cnt) {
        System.out.println("Enter Dinner Event # " + (cnt + 1));
        Employee[] emps = new Employee[15];
        String eventNum;
        int guests, count;
        DinnerEvent event;
